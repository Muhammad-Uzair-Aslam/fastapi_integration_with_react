...
const ResetPasswordPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    console.log('ResetPasswordPage: Form submitted', { email });
    setLoading(true);
    setError('');
    setMessage('');
    ...
    try {
      ...
      console.log('ResetPasswordPage: Password reset request successful', {
      ...
      console.error('ResetPasswordPage: Password reset error', {
        error: errorMessage,
      ...
      setLoading(false);
      console.log('ResetPasswordPage: Request completed', { loading: false });
    }
  };
      ...
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <div className="mt-4 text-center">
          <a
            ...
            onClick={() => console.log('ResetPasswordPage: Navigating to /login')}
          >
            Back to Login
          </a>
        </div>
